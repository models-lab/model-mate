package modelmate.dataset.classdiagram;
...
import modelmate.dataset.GenerateEcoreDataset;
import modelset.process.textual.CodeXGlueOutput;
import modelset.process.textual.CodeXGlueOutput.PieceOfCode;
import picocli.CommandLine;
import picocli.CommandLine.Command;
import modelset.process.textual.TextUtils;

@Command(name = "generate-cd-dataset", mixinStandardHelpOptions = true, description = "Generates dataset for class daigram editors")
public class GenerateClassDiagramDataset extends GenerateEcoreDataset {

    public static void main(String[] args) {
        int exitCode = new CommandLine(new GenerateClassDiagramDataset()).execute(args);
